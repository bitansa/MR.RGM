...
// Do MCMC sampling with threshold prior for the model when both X and Y are there and Sigma follows inverse wishart distribution
// [[Rcpp::export]]
Rcpp::List RGM_Threshold_IW(const arma::mat& S_YY, const arma::mat& S_YX, const arma::mat& S_XX, const arma::mat& D,
