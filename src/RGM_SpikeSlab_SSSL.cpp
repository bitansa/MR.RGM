...
// [[Rcpp::export]]
Rcpp::List RGM_SpikeSlab_SSSL(const arma::mat& S_YY, const arma::mat& S_YX, const arma::mat& S_XX, const arma::mat& D, double n, int nIter, int nBurnin,
    ...
    for (int j = 0; j < p; j++) {
      ...
      for (int l = 0; l < k; l++) {
        ...
        if (D(j, l) != 0) {
          ...
          // Sample b
          Rcpp::List Output1 = Sample_B_Full(S_YX, S_XX, B, B, j, l, Sigma_Inv, MultMat, n, Phi(j, l),
                                                            Eta(j, l), nu_2, Prop_VarB, -1, Trace1, Trace2);
          double b = Output1[0];
