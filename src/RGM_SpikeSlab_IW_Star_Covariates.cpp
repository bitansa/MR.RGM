...
// Do MCMC sampling with Spike and Slab Prior for the model when Y and U are there and Sigma is full with IW prior on it
// [[Rcpp::export]]
Rcpp::List RGM_SpikeSlab_IW_Star_Covariates(const arma::mat& S_YY, const arma::mat& S_YU, const arma::mat& S_UU,
                                            double n, int nIter, int nBurnin,
                                            int Thin, double a_rho = 3.0, double b_rho = 1.0,
                                            double nu_1 = 0.001, double Prop_VarA = 0.01, double TAU = 2){
  ...
  for(int i = 1; i <= nIter; i++){
    ...
    arma::mat param2 = n * MultMat * S_YY * MultMat.t()
