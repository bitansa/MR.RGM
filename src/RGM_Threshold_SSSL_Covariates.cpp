...
// Do MCMC sampling with threshold prior for the model when X, Y and U are there and Sigma is full with spike and slab prior on it
// [[Rcpp::export]]
Rcpp::List RGM_Threshold_SSSL_Covariates(const arma::mat& S_YY, const arma::mat& S_YX, const arma::mat& S_XX,
